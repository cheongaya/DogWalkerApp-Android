...
//    Intent serviceIntent; //TODO : 서비스 테스트
...
//                    tvChatShowMsg.append(message.obj.toString() + "\n");
                    makeLog(new Object() {
                    }.getClass().getEnclosingMethod().getName() + "()", "[반려인 리스트] 서버로부터 받은 메세지 : "+message.obj);
...
//                                        makeToast("채팅 상대방이 메세지를 보내고 있습니다");
    ...
    public void recyclerViewInitSetting(){
        ...
        recyclerViewOwnerChatList.setAdapter(chatListAdapter);
    }
...
//                    serviceIntent = new Intent(OwnerChatListActivity.this, ChatService.class);
