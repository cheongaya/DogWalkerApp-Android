...
public class WalkerReviewManageDTO {
    ...
    public WalkerReviewManageDTO(int review_idx, int review_booking_id, String review_owner_id, String review_owner_profile_img, String review_memo, String review_created_date, ArrayList<String> multiFileArrayList, int reply_idx, int reply_review_id, String reply_walker_id, String reply_memo, String reply_created_date, String reply_updated_date, String reply_deleted_date) {
