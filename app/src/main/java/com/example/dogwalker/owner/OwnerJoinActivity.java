...
public class OwnerJoinActivity extends BaseActivity implements Validator.ValidationListener {
...
//        setContentView(R.layout.activity_owner_join);
    ...
    public void onDuplicateCheckOwnerID(View view){
...
//        makeToast("유효성 검사 성공");
    ...
    public void duplicateCheckUserID(){
        Call<ResultStrDTO> call = retrofitApi.duplicateIdCheck("user_owner", editTextID.getText().toString());
